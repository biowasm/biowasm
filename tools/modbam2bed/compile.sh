...
emmake make modbam2bed CC=emcc AR=emar \
    CFLAGS="-DNOTHREADS -DWASM -s ERROR_ON_UNDEFINED_SYMBOLS=0 -s USE_ZLIB=1 -s USE_BZIP2=1 -fno-stack-protector -O3  --preload-file test_data@/modbam2bed/test_data $CFLAGS_LZMA" \
