...
emcc -O2 -o bigBedToBed.html bigBedToBed.o ../../lib/x86_64/jkweb.a ../../htslib/libhts.a -lm \
  -s ERROR_ON_UNDEFINED_SYMBOLS=0 -s USE_ZLIB=1 --preload-file test.bb -s EXPORTED_RUNTIME_METHODS=["callMain","FS"]
...
emcc -O2 -o bigWigToWig.html bigWigToWig.o ../../lib/x86_64/jkweb.a ../../htslib/libhts.a -lm \
  -s ERROR_ON_UNDEFINED_SYMBOLS=0 -s USE_ZLIB=1 --preload-file test.bw -s EXPORTED_RUNTIME_METHODS=["callMain","FS"]
